...
type Props = {
    ...
    techs?: { id: number, email: string }[],
    isEditable?: boolean,
}


export default function TicketForm({ customer, ticket, techs, isEditable = ture }: Props) { 
    const isManager = Array.isArray(techs)

    const defaultValues: insertTicketSchemaType = customer ? {
        id: ticket?.id ?? "(New)",
